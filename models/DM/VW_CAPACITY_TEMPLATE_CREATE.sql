...
(
    select
        ...
        clinic.case_id as clinic_case_id,
        ...
        'https://www.commcarehq.org/a/{{get_domain_name()}}/app/v1/a1a67a223416440199f060b6a94d15a6/view_facility/?case_id=' as view_more_info_smartlink_referrals,
        'https://www.commcarehq.org/a/{{get_domain_name()}}/app/v1/1e8de29bae5745e99ed2fb1d1a55adac/view_facility/?case_id=' as view_more_info_smartlink_bed_tracker,
        '0' as open_beds,
