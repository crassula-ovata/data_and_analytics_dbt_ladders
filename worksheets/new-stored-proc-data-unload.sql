...
CREATE OR REPLACE PROCEDURE sp_data_unload_test(type STRING, subtype STRING, domain STRING, dl_db STRING, dl_schema STRING, dm_db STRING, steps STRING, path_time_override STRING)
...
BEGIN
  ...
  ELSE 
      ...
      FOR i IN 0 TO step_count DO
          ...
          WHEN 'UNLOAD_SF_TO_S3_GCP_LOCATION' THEN
              CALL METADATA.PROCEDURES.sp_s3_data_unload('DATA_UNLOAD', 'location', 'DM.VW_LOCATION_CREATE_NEW', :domain, :dl_db, :dl_schema, :dm_db, :task_id, :path_time_override) INTO :step_result;
          ELSE
